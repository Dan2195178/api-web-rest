...
class VinsControleur extends Controleur {
     /**
     *  Implémenter chacune des opérations des données vins...
     *  
    ...
    public function ajouter($entite) //$entite => $vin
    {
        $this->reponse['entete_statut'] = 'HTTP/1.1 201 Created';
        $this->reponse['corps'] = ['vin_id' => $this->modele->ajouter(json_decode($entite))];
    }
